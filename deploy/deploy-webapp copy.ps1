...
$webapiUrl = "app-ubs-copichat-2ycenmsokl5kq-webapi.azurewebsites.net"
$webapiName = "app-ubs-copichat-2ycenmsokl5kq-webapi"
...
swa deploy -S $Subscription -T 9949b36b-3e98-42ea-9b87-daaf71796a86 -n swa-ubs-copichat-2ycenmsokl5kq
if ($LASTEXITCODE -ne 0) {
    exit $LASTEXITCODE
}
